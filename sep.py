...
def separate_sheet():
    ...
    if not xlsx_files:
        QMessageBox.warning(
            None, "Nenhum Arquivo", "Nenhum arquivo .xlsx encontrado na pasta 'upload_file'. Por favor, adicione um arquivo .xlsx antes de continuar.", QMessageBox.Ok)
        return_menu = True  # Defina para True para voltar para o menu
        return
